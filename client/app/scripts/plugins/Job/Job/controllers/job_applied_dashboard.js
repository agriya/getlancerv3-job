...
angular.module('getlancerApp.Job')
    .controller('JobsAppliedDashboardController', ['$scope', '$rootScope', '$window', '$filter', '$state', 'jobAppliedFactory', 'JobSalaryTypeFactory', '$timeout', 'SalaryType', 'DateFormat', 'md5', function($scope, $rootScope, $window, $filter, $state, jobAppliedFactory, JobSalaryTypeFactory, $timeout, SalaryType, DateFormat, md5) {
        /**
         * @ngdoc method
